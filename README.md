...
В меню **F8** также встроена функция **экстренного разбаговывания порталов** — если игра зависла в бесконечном огненном вихре/туннеле телепортации (баг загрузки секторов с модами), откройте меню F8 и нажмите **«⚡ Разбаговать здесь»** (или «↩ Вернуть к источнику»), чтобы мгновенно вернуть управление персонажем.
